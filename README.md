This template is to launch the beanstalk pipeline.  to use this template you need to modify or create the terraform.tfvars file one. here is the file content. 
